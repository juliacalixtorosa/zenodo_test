...
The study evaluates the impact of systematic refactoring on **cyclomatic complexity**, **Halstead metrics**, **size metrics (LOC)**, and the **maintainability index**, comparing the system state **before and after** the refactoring process.
...
The data correspond to two experimental checkpoints:
